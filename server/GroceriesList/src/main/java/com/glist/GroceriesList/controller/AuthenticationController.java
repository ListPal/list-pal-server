...
public class AuthenticationController {
    ...
    public ResponseEntity<UserAuthenticationResponse> authenticate(HttpServletResponse response, @RequestBody AuthenticationRequest body) throws AccessDeniedException {
